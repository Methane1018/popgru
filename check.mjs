...
// 要用除法：X 是「快幾倍」，永遠除不到 0。
{
  check('金魚門檻用除法', /goldfishOdds \/ \(1 \+/.test(store));
  check('沒有殘留的 (1 - 增益) 乘法', !/goldfishOdds \* \(1 -/.test(store));
  // 折扣還是 (1 - X) 的形式，但一定要有天花板，不然遲早變免費
  check('折扣有夾上限', /Math\.min\(TUNING\.maxDiscount/.test(store));
